...
Run these from inside `interlinks/`:
...
Because the app root is `interlinks/` (the repo root holds the PRD), set the **Root Directory** to `interlinks` when you create the Vercel project.
